...
function addNote(noteObject) {
    var notes = document.getElementById('notes'); // targets a notes div of html
    noteschild = document.createElement('div'); // creates a noteschild div - for future use :)
    notes.appendChild(noteschild) // put the newly created noteschild div inside of notes div
    var note = document.createTextNode(noteObject.content); // appendChild - function below - accepts only data of Node type.
